...
CREATE OR REPLACE FUNCTION f_for_trg_track_changes()
  RETURNS trigger AS
$BODY$
BEGIN
...
CREATE OR REPLACE FUNCTION f_for_trg_track_history()
  RETURNS trigger AS
$BODY$
DECLARE
...
CREATE OR REPLACE FUNCTION get_translation(mixed_value character varying, language_code character varying)
